...
public class LoansController {
    ...
    public LoansController(@Value("${build.version}") String buildVersion, ILoansService iLoansService) {
    ...
    @Operation(
            ...
            description = "Get Contact Info that can be reached out in case of any issue"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
